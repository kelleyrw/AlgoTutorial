...
class SimpleTableCellSetter;    // class for implementing SimpleTable::setTable()
class SimpleTableRowAppender;   // class for implementing SimpleTable::setTable()
class SimpleTableColumnLabeler; // class for implementing SimpleTable::setCells()
...
public:
    SimpleTable();
    ~SimpleTable();
    SimpleTableColumnLabeler setTable();
    SimpleTableCellSetter    setCells();
    ...
    friend std::ostream& operator << (std::ostream& os, SimpleTable& table);
};

// for the templates functions
#include "SimpleTable.impl.h"

#endif // #define SimpleTable_H